...
<div id="wrap">
                      ...
                      <!-- True Content start -->
							...
							<div class="page_navi">
                               ...
                               <c:if test="${sessionScope.loginMember.status eq 9 }"> 
                               		<button style="float: right; margin-bottom: 10px; background: #c39f78; color: white; width:45px; height:25px;" type="button" onclick="location.href='${pageContext.request.contextPath}/board_manager?category=2';">글쓰기</button>                 
                               </c:if>
	...
	function boardDisplay(pageNum) {
		...
		$.ajax({
			type: "get",
			url: "board_list?pageNum="+pageNum+"&category=2",
			dataType: "json",
	...
	function pageDisplay(pager) {
		...
		if(pager.startPage>pager.blockSize) {
			html+="<a href='javascript:boardDisplay("+pager.prevPage+");'><img src='${pageContext.request.contextPath}/images/btn/ico_pre.gif' border='0' style='max-width:10px;'/></a>";
		} else {
		...
		if(pager.endPage!=pager.totalPage) {
			html+="<a href='javascript:boardDisplay("+pager.nextPage+");'><img src='${pageContext.request.contextPath}/images/btn/ico_next.gif' border='0' style='max-width:10px;' /></a>";
		} else {
