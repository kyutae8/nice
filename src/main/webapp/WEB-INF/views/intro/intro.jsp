...
<ul class="menu5">
	<li class="nav_sub cool-link3"><a class="on" href="${pageContext.request.contextPath }/intro/intro">소개및개요</a></li>
	<li class="nav_sub cool-link3"><a href="${pageContext.request.contextPath }/intro/ceo">인사말</a></li>
	<li class="nav_sub cool-link3"><a href="${pageContext.request.contextPath }/intro/map">오시는길</a></li>
</ul>
   ...
   <!-- True Content start -->
                       ...
                       <!-- True Content start -->
							...
							<div class="page_navi">
                                        ...
                                        <span><img src="${pageContext.request.contextPath }/images/icon/ico_I.gif" /></span>
                                        <span class="thispage">소개및개요</span>
                                 	</div>
                            	<div class="subTitAll">
                                    <div class="subTitArea">
                                   	  <img src="${pageContext.request.contextPath }/images/subTit/intro01.jpg" alt="소개및개요" />
                                    </div>

                                </div>
                               <div class="subTxtArea">
									<img src="${pageContext.request.contextPath }/intro/intro1.jpg" />
								</div>
                      <!-- //True Content end -->          
                        </div>
                        </div>
