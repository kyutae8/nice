<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="courseImg">
						<img src="${pageContext.request.contextPath }/images/map/map01.gif" usemap="#transportPointer"  class="mapimgline"/>
						<map name="transportPointer" id="transportPointer">
							<area shape="rect" coords="128,442,189,490"  href="#none" onmouseover="popShow(0)" alt="5번경로" />
							<area shape="rect" coords="236,465,297,514"  href="#none" onmouseover="popShow(1)" alt="6번경로" />
						</map>
                    ...
                    <div class="courseTable">
						...
						<div id="mapWrap" class="mapWrap">
							<!-- step1 -->
							<ul>
								<li class="pic"><img src="${pageContext.request.contextPath }/images/map/spic01.jpg"></li>
								<li class="subscript" style="letter-spacing:-1px;">이마트앞 삼성디지털프라자 끼고 좌회전</li>
							</ul>
							<!-- //step1 -->
							<!-- step2 -->
							<ul>
								<li class="pic"><img src="${pageContext.request.contextPath }/images/map/spic02.jpg"></li>
