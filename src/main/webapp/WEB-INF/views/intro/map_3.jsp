<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<div class="courseImg">
						<img src="${pageContext.request.contextPath }/images/map/map03.gif" usemap="#transportPointer"    class="mapimgline"/>
						<map name="transportPointer" id="transportPointer">
							<area shape="rect" coords="123,441,186,486"  href="#none" onmouseover="popShow(0)" alt="2번경로" />
							<area shape="rect" coords="239,474,298,517"  href="#none" onmouseover="popShow(1)" alt="3번경로" />
						</map>
                    ...
                    <div class="courseTable">
						...
						<div id="mapWrap" class="mapWrap">
							<!-- step1 -->
							<ul>
								<li class="pic"><img src="${pageContext.request.contextPath }/images/map/spic05.jpg"></li>
								<li class="subscript">이마트앞 삼성디지털프라자 끼고 좌회전</li>
							</ul>
							<!-- //step1 -->
							<!-- step2 -->
							<ul>
								<li class="pic"><img src="${pageContext.request.contextPath }/images/map/spic06.jpg"></li>
